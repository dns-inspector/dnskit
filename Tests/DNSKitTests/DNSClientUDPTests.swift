...
final class DNSClientUDPTests: XCTestCase, IClientTests {
    ...
    func testQueryUTF8() async throws {
        try await ClientTests(transportType: .DNS, serverAddress: "1.1.1.1:53").testQueryUTF8()
    }
    ...
    func testAuthenticateTLD() async throws {
        try await ClientTests(transportType: .DNS, serverAddress: "1.1.1.1:53").testAuthenticateTLD()
    }
