...
final class MessageTests: XCTestCase {
    ...
    func testParseDNSCAAMessage() throws {
        let data = Data([ 0xc9, 0x14, 0x81, 0xa0, 0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x0c, 0x74, 0x6c, 0x73, 0x69, 0x6e, 0x73, 0x70, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x03, 0x63, 0x6f, 0x6d, 0x00, 0x01, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x01, 0x01, 0x00, 0x01, 0x00, 0x00, 0x01, 0x2c, 0x00, 0x16, 0x00, 0x05, 0x69, 0x73, 0x73, 0x75, 0x65, 0x6c, 0x65, 0x74, 0x73, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x2e, 0x6f, 0x72, 0x67, 0xc0, 0x0c, 0x01, 0x01, 0x00, 0x01, 0x00, 0x00, 0x01, 0x2c, 0x00, 0x1a, 0x00, 0x09, 0x69, 0x73, 0x73, 0x75, 0x65, 0x77, 0x69, 0x6c, 0x64, 0x6c, 0x65, 0x74, 0x73, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x2e, 0x6f, 0x72, 0x67, 0x00, 0x00, 0x29, 0x04, 0xd0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ])
        let message = try Message(messageData: data)
        XCTAssertEqual(message.questions.count, 1)
        XCTAssertEqual(message.answers.count, 2)
        XCTAssertEqual(message.questions[0].name, "tlsinspector.com.")
        XCTAssertEqual(message.answers[0].name, "tlsinspector.com.")
        XCTAssertEqual(message.answers[0].recordType, .CAA)
        guard let data1 = message.answers[0].data as? CAARecordData else { fatalError("answer data incorrect type") }
        XCTAssertEqual(data1.tag, "issue")
        XCTAssertEqual(data1.value, "letsencrypt.org")

        XCTAssertEqual(message.answers[1].name, "tlsinspector.com.")
        XCTAssertEqual(message.answers[1].recordType, .CAA)
        guard let data2 = message.answers[1].data as? CAARecordData else { fatalError("answer data incorrect type") }
        XCTAssertEqual(data2.tag, "issuewild")
        XCTAssertEqual(data2.value, "letsencrypt.org")
    }
    ...
    func testParseDNSTXTMessageEmoji() throws {
        let data = Data([ 0xf2, 0x9d, 0x81, 0x20, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x10, 0x00, 0x01, 0xc0, 0x0c, 0x00, 0x10, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0d, 0x0c, 0xf0, 0x9f, 0x90, 0xb6, 0xf0, 0x9f, 0x90, 0xb1, 0xf0, 0x9f, 0x90, 0xad ])
        let message = try Message(messageData: data)
        XCTAssertEqual(message.questions.count, 1)
        XCTAssertEqual(message.answers.count, 1)
        XCTAssertEqual(message.questions[0].name, "example.com.")
        XCTAssertEqual(message.answers[0].name, "example.com.")
        XCTAssertEqual(message.answers[0].ttlSeconds, 0)
        XCTAssertEqual(message.answers[0].recordType, .TXT)
        guard let data = message.answers[0].data as? TXTRecordData else { fatalError("answer data incorrect type") }
        XCTAssertEqual(data.text, "🐶🐱🐭")
    }

    func testParseDNSTXTMessageLong() throws {
        let data = Data([  ])

        let recordData = try TXTRecordData(recordData: data)
        XCTAssertTrue(recordData.text.count > 0)
    }

    func testParseDNSNSEC3Message() throws {
        let data = Data([  ])
        let message = try Message(messageData: data)
        XCTAssertEqual(message.questions.count, 1)
        XCTAssertEqual(message.answers.count, 0)
        XCTAssertEqual(message.authority.count, 6)
        XCTAssertEqual(message.questions[0].name, "not-exist.example.com.")
        XCTAssertEqual(message.authority[2].name, "onib9mgub9h0rml3cdf5bgrj59dkjhvk.example.com.")
        XCTAssertEqual(message.authority[2].ttlSeconds, 3600)
        XCTAssertEqual(message.authority[2].recordType, .NSEC3)
        guard let data = message.authority[2].data as? NSEC3RecordData else { fatalError("answer data incorrect type") }
        XCTAssertEqual(data.types.count, 7)
        XCTAssertEqual(data.description, "1 1 - c6dacc1cda946c446234e0dd0b133ad23b688c8d 51 A AAAA MX NS RRSIG SOA")
    }

    func testParseDNSNSECMessage() throws {
        let data = Data([ ,  ])
        let message = try Message(messageData: data)
        XCTAssertEqual(message.questions.count, 1)
        XCTAssertEqual(message.answers.count, 0)
        XCTAssertEqual(message.authority.count, 4)
        XCTAssertEqual(message.authority[2].name, "not-exist.example.com.")
        XCTAssertEqual(message.authority[2].ttlSeconds, 1601)
        XCTAssertEqual(message.authority[2].recordType, .NSEC)
        guard let data = message.authority[2].data as? NSECRecordData else { fatalError("answer data incorrect type") }
        XCTAssertTrue(data.nextName.contains(".not-exist.example.com."))
