...
final class TLSClientTests: XCTestCase, IClientTests {
    ...
    func testQueryUTF8() async throws {
        try await ClientTests(transportType: .TLS, serverAddress: "1.1.1.1:853").testQueryUTF8()
    }
    ...
    func testAuthenticateTLD() async throws {
        try await ClientTests(transportType: .TLS, serverAddress: "1.1.1.1:853").testAuthenticateTLD()
    }
